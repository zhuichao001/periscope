 ...
 */
@Service
public class IncrByFloatHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getStringRedisService().incrByFloat(commandList.get(0), Double.valueOf(commandList.get(1)));
    }
}
