 ...
 */
@Slf4j
@Service(value = "lindexHandler")
public class LindexHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().lIndex(commandList.get(0), Long.valueOf(commandList.get(1)));
    }
}
