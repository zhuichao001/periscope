 ...
 */
@Slf4j
@Service(value = "rpoplpushHandler")
public class RpoplpushHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().rPopLPush(commandList.get(0), commandList.get(1));
    }
}
