 ...
 */
@Slf4j
@Service(value = "lremHandler")
public class LremHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().lRem(commandList.get(0), Long.valueOf(commandList.get(1)), commandList.get(2));
    }
}
