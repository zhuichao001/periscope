...
@Slf4j
@Service(value = "expireAtHandler")
public class ExpireAtHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        Long unixTime = Long.valueOf(commandList.get(1));

        return redisService.getExpireRedisService().expireAt(key, unixTime);
    }
}
