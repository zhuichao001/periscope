 ...
 */
@Slf4j
@Service(value = "lpushxHandler")
public class LpushxHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().lPushX(commandList.get(0), commandList.get(1));
    }
}
