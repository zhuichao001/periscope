...
@Slf4j
@Service(value = "zRangeByLexHandler")
public class ZRangeByLexHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getSortedSetRedisService().zrangeByLex(key, min, max);
    }
