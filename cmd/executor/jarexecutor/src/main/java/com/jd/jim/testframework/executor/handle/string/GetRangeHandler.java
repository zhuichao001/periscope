 ...
 */
@Service
public class GetRangeHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getStringRedisService().getRange(commandList.get(0), Long.valueOf(commandList.get(1)), Long.valueOf(commandList.get(2)));
    }
}
