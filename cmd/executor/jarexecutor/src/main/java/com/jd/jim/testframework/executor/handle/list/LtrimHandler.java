 ...
 */
@Slf4j
@Service(value = "ltrimHandler")
public class LtrimHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().lTrim(commandList.get(0), Long.valueOf(commandList.get(1)), Long.valueOf(commandList.get(2)));
    }
}
