...
@Slf4j
@Service(value = "zCountHandler")
public class ZCountHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        double min = Double.parseDouble(commandList.get(1));
        double max = Double.parseDouble(commandList.get(2));

        return redisService.getSortedSetRedisService().zcount(key, min, max);
    }
