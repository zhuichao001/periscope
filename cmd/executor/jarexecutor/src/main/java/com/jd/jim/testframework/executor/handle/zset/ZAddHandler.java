...
@Slf4j
@Service(value = "zAddHandler")
public class ZAddHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        double score = Double.parseDouble(commandList.get(1));
        String member = commandList.get(2);

        return redisService.getSortedSetRedisService().zadd(key, score, member);
    }
