...
@Slf4j
@Service(value = "zRemRangeByLexHandler")
public class ZRemRangeByLexHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getSortedSetRedisService().zremrangeByLex(key, min, max);
    }
