 ...
 */
@Slf4j
@Service(value = "lsetHandler")
public class LsetHandler extends BaseHandler {
    ...
    public String handle(List<String> commandList) {
        ...
        return redisService.getListRedisService().lSet(commandList.get(0), Long.valueOf(commandList.get(1)), commandList.get(2));
    }
}
